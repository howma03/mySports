...
/** @namespace Namespace for MYSPORTSAPP classes and functions. */
var MYSPORTSAPP = MYSPORTSAPP || {};
...
MYSPORTSAPP = {
    ...
    groupsForUserUrl: function () {
        return this.baseUrl + "/group/user/";
    },

    sportsUrl: function () {
        return this.baseUrl + "/sport/";
    },
